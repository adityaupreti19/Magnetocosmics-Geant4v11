...
//
//
// $Id: MYTransportation.cc,v 1.27 2001/12/08 15:20:30 japost Exp $
...
MYTransportation::MYTransportation(const G4Monopole* mpl) :
G4VProcess(G4String("MYTransportation") ), fParticleDef(mpl),
	fMagSetup(0)
{
  //const MAGCOSGeometryConstruction* detector =
  //  static_cast<const MAGCOSGeometryConstruction*>
		                              ...
		                              G4GPILSelection* selection  )
{
  ...
  *selection = CandidateForSelection ;
  ...
  G4String particleName = pParticle->GetParticleDefinition()->GetParticleName();
  G4cout << "PARTICLE NAME is " << particleName << G4endl;
  //G4double              particleCharge = pParticleDef->GetPDGCharge() ; 

  //G4ChargeState particleCharge = pParticleDef->GetPDGCharge();
  G4double Charge = pParticleDef->GetPDGCharge();
  //G4ChargeState particleCharge(Charge, pParticleDef->GetPDGSpin(),
  //                             0,   //  Magnetic moment:  
  //                             0,   //  Electric Dipole moment 
  //                             0);

  //if (particleName == "monopole"){
  G4cout << "THIS PARTICLE IS A " << particleName << G4endl;
  particleMagneticCharge = 0;
  G4ChargeState particleCharge(Charge, fParticleDef->GetPDGSpin(),
			       0,   //  Magnetic moment:  
                               0,   //  Electric Dipole moment 
  ...
  G4cout << " G4Transport:  field exerts force= " << fieldExertsForce << G4endl;
 //           << "  fieldMgr= " << fieldMgr << G4endl;
  ...
  else
  {
     ...
     G4cout << "===================================" << G4endl;
     G4cout << "from the field propagator" << G4endl;
     G4cout << "particle momentum is " << momentumMagnitude << G4endl;
     G4cout << "particle Mass is " << restMass  << G4endl;
     G4cout << "===================================" << G4endl;
