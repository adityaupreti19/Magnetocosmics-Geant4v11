...
////////////////////////////////////////////////////////////////////////////////
//
MAGCOSApplicationScenario::MAGCOSApplicationScenario(HistoManager* histo): fHistoManager(histo)
{ 
  ...
  //ana->SetFileName("Cosmics");
  //G4cout << "The file name is set as Cosmics" << G4endl;
  //ana->SetNtupleFileName(0, "run1");
  G4cout << "magcos application scenario" << G4endl; 
}
////////////////////////////////////////////////////////////////////////////////
//
...
{ if (TotalDurationReached) {
 ...
 //select the bline equation
  ...
  //theEquation->SetEquationType("MONOPOLE");
...
{ 
 ...
 //select the bline equation
  //theEquation->SetEquationType("LORENTZ_MOTION"); 
  theEquation->SetEquationType("MONOPOLE");   // this sets the equation of motion of a monopole.
  //G4cout << "The Monopole equation of motion is set" << G4endl;
 ...
 //integration
  //theEquation->SetReverseTimeMode(false);
  G4RunManager::GetRunManager()->BeamOn(1);  //this sets the number of events in a run. 
