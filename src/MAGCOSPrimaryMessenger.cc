//the source file for conecting primary generation action to the macro
//using commands to define the initial position, direction, coordinate system, etc. 
...
{ 
  G4cout << "primary messenger" << G4endl;
  G4UIparameter* param;
  G4String cmd_name;
  G4String guidance;
