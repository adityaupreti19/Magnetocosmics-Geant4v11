...
{public:
  ...
  //BSEquationInG4(G4MonopoleEquation* anEquation, G4Navigator* aNavigator);
  //BSEquationInG4(MAGCOSEquationOfMotion* anEquation, G4Navigator* aNavigator);
  BSEquationInG4();
  ~BSEquationInG4();
  ...
  //inline void SetEquationOfMotion(G4MonopoleEquation* anEquation )
	// 			     {fEquation = anEquation;}	 
 
  //inline void SetEquationOfMotion(MAGCOSEquationOfMotion* anEquation )
  //                                   {fEquation = anEquation;}
  ...
  //inline G4MonopoleEquation* GetEquationOfMotion( )
	//			    {return fEquation;}
...
// method to compute the trajectory		      
 ...
 private:
  ...
  //G4MonopoleEquation* fEquation;
  //MAGCOSEquationOfMotion* fEquation;
