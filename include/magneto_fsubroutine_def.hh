...
{extern void f_chang_coord__(int* , char* ,float* ,
 ...
 extern void igrf_to_cc_(float*,float*,float*,
                          float*,float*,float*);
 extern void  t89c_(int*,float*, float*,float*,float*,float*,
                                            float*,float*,float* );
 extern void  t89c_boberg_(int*,float*, float*,float*,float*,float*,
                                            float*,float*,float* );					    
 extern void  mcos_t96_01_(int*,float*, float*,float*,float*,float*,
                                            float*,float*,float* );			  	
 extern void  t01_01_(int*,float*, float*,float*,float*,float*,
                                            float*,float*,float* );
#ifdef  USE_TSY04
